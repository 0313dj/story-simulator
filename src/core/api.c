                  ...
                  const char *selected_vars, FullResponse *result)
{
    ...
    snprintf(sys_prompt, sizeof(sys_prompt),
        ...
        "  好感度变更幅度不宜超过±10\n"
        "  技能变更: 技能名+增量 或 技能名=新值，技能等级范围0-100，单次变化不超过±10\n"
        ...
        "LOCATION: <新地点，格式: 大地点/小地点/具体地点，不变留空。例如: 区域/街道/建筑>\n\n"
        "【时代约束】\n"
        ...
        "NPC_SPAWN: <有角色卡的NPC出场判定，每行一个。格式: NPC名称|MUST或MAYBE或NEVER|大地点/小地点/具体地点>\n"
        "  例如: NPC名|MUST|区域/街道/建筑\n"
        ...
        "        skill.技能名=等级(0-100), item.物品名=数量\n"
    ...
    const char *story, WorldCreateResult *result)
{
    ...
    const char *sys =
        ...
        "可选: skill.技能名=等级(0-100), item.物品名=数量\n\n"
        "LOCATIONS:\n"
        "<至少15个中文地名，每行: 名称|x|y，坐标0-999。例如: 地名|500|300>\n\n"
        "START:\n"
        "<起始地点，格式: 大地点/小地点/具体地点，全部中文。例如: 区域/街道/建筑>\n\n"
        "TIME:\n"
